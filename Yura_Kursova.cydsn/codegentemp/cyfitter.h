...
/* LED_On */
#define LED_On__0__INTTYPE CYREG_PICU2_INTTYPE1
#define LED_On__0__MASK 0x02u
#define LED_On__0__PC CYREG_PRT2_PC1
#define LED_On__0__PORT 2u
#define LED_On__0__SHIFT 1u
#define LED_On__AG CYREG_PRT2_AG
#define LED_On__AMUX CYREG_PRT2_AMUX
#define LED_On__BIE CYREG_PRT2_BIE
#define LED_On__BIT_MASK CYREG_PRT2_BIT_MASK
#define LED_On__BYP CYREG_PRT2_BYP
#define LED_On__CTL CYREG_PRT2_CTL
#define LED_On__DM0 CYREG_PRT2_DM0
#define LED_On__DM1 CYREG_PRT2_DM1
#define LED_On__DM2 CYREG_PRT2_DM2
#define LED_On__DR CYREG_PRT2_DR
#define LED_On__INP_DIS CYREG_PRT2_INP_DIS
#define LED_On__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define LED_On__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define LED_On__LCD_EN CYREG_PRT2_LCD_EN
#define LED_On__MASK 0x02u
#define LED_On__PORT 2u
#define LED_On__PRT CYREG_PRT2_PRT
#define LED_On__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define LED_On__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define LED_On__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define LED_On__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define LED_On__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define LED_On__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define LED_On__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define LED_On__PS CYREG_PRT2_PS
#define LED_On__SHIFT 1u
#define LED_On__SLW CYREG_PRT2_SLW

/* Pump_On */
#define Pump_On__0__INTTYPE CYREG_PICU2_INTTYPE0
#define Pump_On__0__MASK 0x01u
#define Pump_On__0__PC CYREG_PRT2_PC0
#define Pump_On__0__PORT 2u
#define Pump_On__0__SHIFT 0u
#define Pump_On__AG CYREG_PRT2_AG
#define Pump_On__AMUX CYREG_PRT2_AMUX
#define Pump_On__BIE CYREG_PRT2_BIE
#define Pump_On__BIT_MASK CYREG_PRT2_BIT_MASK
#define Pump_On__BYP CYREG_PRT2_BYP
#define Pump_On__CTL CYREG_PRT2_CTL
#define Pump_On__DM0 CYREG_PRT2_DM0
#define Pump_On__DM1 CYREG_PRT2_DM1
#define Pump_On__DM2 CYREG_PRT2_DM2
#define Pump_On__DR CYREG_PRT2_DR
#define Pump_On__INP_DIS CYREG_PRT2_INP_DIS
#define Pump_On__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Pump_On__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Pump_On__LCD_EN CYREG_PRT2_LCD_EN
#define Pump_On__MASK 0x01u
#define Pump_On__PORT 2u
#define Pump_On__PRT CYREG_PRT2_PRT
#define Pump_On__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Pump_On__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Pump_On__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Pump_On__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Pump_On__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Pump_On__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Pump_On__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Pump_On__PS CYREG_PRT2_PS
#define Pump_On__SHIFT 0u
#define Pump_On__SLW CYREG_PRT2_SLW

/* FhotoRes */
#define FhotoRes__0__INTTYPE CYREG_PICU0_INTTYPE2
#define FhotoRes__0__MASK 0x04u
#define FhotoRes__0__PC CYREG_PRT0_PC2
#define FhotoRes__0__PORT 0u
#define FhotoRes__0__SHIFT 2u
#define FhotoRes__AG CYREG_PRT0_AG
#define FhotoRes__AMUX CYREG_PRT0_AMUX
#define FhotoRes__BIE CYREG_PRT0_BIE
#define FhotoRes__BIT_MASK CYREG_PRT0_BIT_MASK
#define FhotoRes__BYP CYREG_PRT0_BYP
#define FhotoRes__CTL CYREG_PRT0_CTL
#define FhotoRes__DM0 CYREG_PRT0_DM0
#define FhotoRes__DM1 CYREG_PRT0_DM1
#define FhotoRes__DM2 CYREG_PRT0_DM2
#define FhotoRes__DR CYREG_PRT0_DR
#define FhotoRes__INP_DIS CYREG_PRT0_INP_DIS
#define FhotoRes__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define FhotoRes__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define FhotoRes__LCD_EN CYREG_PRT0_LCD_EN
#define FhotoRes__MASK 0x04u
#define FhotoRes__PORT 0u
#define FhotoRes__PRT CYREG_PRT0_PRT
#define FhotoRes__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define FhotoRes__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define FhotoRes__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define FhotoRes__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define FhotoRes__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define FhotoRes__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define FhotoRes__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define FhotoRes__PS CYREG_PRT0_PS
#define FhotoRes__SHIFT 2u
#define FhotoRes__SLW CYREG_PRT0_SLW

/* HidroSns */
#define HidroSns__0__INTTYPE CYREG_PICU0_INTTYPE1
#define HidroSns__0__MASK 0x02u
#define HidroSns__0__PC CYREG_PRT0_PC1
#define HidroSns__0__PORT 0u
#define HidroSns__0__SHIFT 1u
#define HidroSns__AG CYREG_PRT0_AG
#define HidroSns__AMUX CYREG_PRT0_AMUX
#define HidroSns__BIE CYREG_PRT0_BIE
#define HidroSns__BIT_MASK CYREG_PRT0_BIT_MASK
#define HidroSns__BYP CYREG_PRT0_BYP
#define HidroSns__CTL CYREG_PRT0_CTL
#define HidroSns__DM0 CYREG_PRT0_DM0
#define HidroSns__DM1 CYREG_PRT0_DM1
#define HidroSns__DM2 CYREG_PRT0_DM2
#define HidroSns__DR CYREG_PRT0_DR
#define HidroSns__INP_DIS CYREG_PRT0_INP_DIS
#define HidroSns__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define HidroSns__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define HidroSns__LCD_EN CYREG_PRT0_LCD_EN
#define HidroSns__MASK 0x02u
#define HidroSns__PORT 0u
#define HidroSns__PRT CYREG_PRT0_PRT
#define HidroSns__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define HidroSns__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define HidroSns__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define HidroSns__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define HidroSns__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define HidroSns__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define HidroSns__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define HidroSns__PS CYREG_PRT0_PS
#define HidroSns__SHIFT 1u
#define HidroSns__SLW CYREG_PRT0_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "Yura_Kursova"
