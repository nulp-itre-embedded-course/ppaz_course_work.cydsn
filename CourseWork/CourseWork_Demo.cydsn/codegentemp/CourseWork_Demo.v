// ======================================================================
// CourseWork_Demo.v generated from TopDesign.cysch
// 12/30/2021 at 16:00
...
module DVDAC_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("9fbf095f-a8b0-4552-b128-e70e8956f5ed/16079296-677d-4c97-a0f1-fd79fcfb8c33"),
	...
	cy_clock_v1_0
		#(.id("9fbf095f-a8b0-4552-b128-e70e8956f5ed/2b3078c1-9a14-4aea-bb80-3826ca4e0c90"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("4000000000"),
		  .is_direct(0),
...
module top ;
    ...
    Timer_v2_80_2 SamplingTimer (
        ...
        .tc(Net_8),
        .trigger(1'b1));
    defparam SamplingTimer.CaptureCount = 2;
    defparam SamplingTimer.CaptureCounterEnabled = 0;
    defparam SamplingTimer.DeviceFamily = "PSoC5";
    defparam SamplingTimer.InterruptOnCapture = 0;
    defparam SamplingTimer.InterruptOnTC = 1;
    defparam SamplingTimer.Resolution = 16;
    defparam SamplingTimer.SiliconRevision = "0";
