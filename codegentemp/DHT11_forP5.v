// ======================================================================
// DHT11_forP5.v generated from TopDesign.cysch
// 01/27/2021 at 17:40
...
module top ;
	...
	wire [0:0] tmpOE__PhotoSen_net;
	wire [0:0] tmpIO_0__PhotoSen_net;
	wire [0:0] tmpINTERRUPT_0__PhotoSen_net;
	electrical [0:0] tmpSIOVREF__PhotoSen_net;

	cy_psoc3_pins_v1_10
		#(.id("eeb2825e-b082-494b-b710-f84325acfba4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PhotoSen
		 (.oe(tmpOE__PhotoSen_net),
		  .y({1'b0}),
		  .fb({Net_26}),
		  .io({tmpIO_0__PhotoSen_net[0:0]}),
		  .siovref(tmpSIOVREF__PhotoSen_net),
		  .interrupt({tmpINTERRUPT_0__PhotoSen_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PhotoSen_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MicSen_net;
	wire [0:0] tmpIO_0__MicSen_net;
	wire [0:0] tmpINTERRUPT_0__MicSen_net;
	electrical [0:0] tmpSIOVREF__MicSen_net;

	cy_psoc3_pins_v1_10
		#(.id("07d6ef1d-4a78-4e62-8c09-2a4455ee87be"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MicSen
		 (.oe(tmpOE__MicSen_net),
		  .y({1'b0}),
		  .fb({Net_27}),
		  .io({tmpIO_0__MicSen_net[0:0]}),
		  .siovref(tmpSIOVREF__MicSen_net),
		  .interrupt({tmpINTERRUPT_0__MicSen_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MicSen_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
