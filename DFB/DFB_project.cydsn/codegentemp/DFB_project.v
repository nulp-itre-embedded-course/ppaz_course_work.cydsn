// ======================================================================
// DFB_project.v generated from TopDesign.cysch
// 12/31/2021 at 01:01
...
module DVDAC_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("76016f43-92ea-4a69-bd97-c1c3bc78c997/16079296-677d-4c97-a0f1-fd79fcfb8c33"),
	...
	cy_clock_v1_0
		#(.id("76016f43-92ea-4a69-bd97-c1c3bc78c997/2b3078c1-9a14-4aea-bb80-3826ca4e0c90"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("4000000000"),
		  .is_direct(0),
...
module top ;
    ...
    UART_v2_50_4 UART (
        ...
        .rx_clk(Net_148),
        .rx_data(Net_149),
        .rx_interrupt(Net_150),
        .tx(Net_151),
        .tx_clk(Net_152),
        .tx_data(Net_153),
        .tx_en(Net_154),
        .tx_interrupt(Net_155));
